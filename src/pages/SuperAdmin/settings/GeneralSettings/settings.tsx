...
const Settings = () => {
  ...
  return (
    <div>
      <div className="relative max-w-full border rounded-xl bg-white mt-8">
        ...
        <div className="flex items-center mb-10 mt-24 gap-[24px] justify-center flex-wrap">
          <div>
            <button
              type="button"
              className="px-28 py-2.5 border border-[#16ceaa] rounded-3xl text-base font-medium text-[#16ceaa]"
            >
              Cancel
            </button>
          </div>
          <div>
            <button
              type="button"
              className={`px-28 py-2.5 rounded-3xl text-base font-medium text-white focus:outline-none bg-[#16ceaa] shadow-[0_26px_46px_0_rgba(22,206,170,0.35)] opacity-40`}
            >
              Update
            </button>
          </div>
