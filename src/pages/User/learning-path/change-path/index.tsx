...
const ChoosePath = ({ handleBack, handleSubmit, selectedTechnicalPath, setSelectedTechnicalPath, salesPath, technicalOptions1Array, chosenTrack }: any) => {
  const minTechnicalPaths = 3;
