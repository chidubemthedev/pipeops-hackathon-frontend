...
export const Button = ({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className={`${className} flex w-full justify-center items-center rounded-[30px] h-[52px] bg-primary px-3 py-1.5 text-sm font-semibold leading-6 text-white hover:bg-primaryHover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#7447aa] transition ease-in duration-200 disabled:cursor-not-allowed disabled:bg-primary disabled:opacity-50`}
    >
